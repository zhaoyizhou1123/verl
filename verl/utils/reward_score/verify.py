...
def compute_score(solution_str, ground_truth, dataset_name, format_score=0., score=1.):
...
def test():
    solution_str = "\\boxed{\\text{False}}"
    ground_truth=True
    compute_score(solution_str, ground_truth, "verify")
